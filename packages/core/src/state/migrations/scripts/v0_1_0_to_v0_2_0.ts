...
export const migration_v0_1_0_to_v0_2_0: Migration = {
  ...
  down: (state: unknown) => {
    ...
    if ((rest.metadata as Record<string, unknown>)?.templatesAdded !== undefined) {
  ...
  validate: (state: unknown): boolean => {
    ...
    if (s.version === null || s.version === undefined || s.version !== '0.2.0') return false;
    if (s.metadata === null || s.metadata === undefined || typeof s.metadata !== 'object') return false;
