...
export const migration_v0_0_0_to_v0_1_0: Migration = {
  ...
  toVersion: '0.1.0',
  description:
    'Add metadata fields for tracking creation and modification times',
  ...
  up: (state: unknown) => {
    ...
    return {
      ...
      metadata: {
        created:
          (s.created as string | undefined) ??
          (s.createdAt as string | undefined) ??
          now,
        modified:
          (s.modified as string | undefined) ??
          (s.modifiedAt as string | undefined) ??
          (s.lastModified as string | undefined) ??
          now,
        migrationHistory: [],
      },
