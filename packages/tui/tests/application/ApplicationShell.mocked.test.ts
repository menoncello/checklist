...
import { createSimpleMockDependencies } from '../mocks/SimpleMocks';

// Test ID: 2.5-UNIT-001 - ApplicationShell constructor initializes
describe('ApplicationShell with Mocks', () => {
  let config: ApplicationShellConfig;
  let mockDeps: ReturnType<typeof createSimpleMockDependencies>;
  ...
  beforeEach(() => {
    ...
    mockDeps = createSimpleMockDependencies(config);
  ...
  describe('Initialization (AC1)', () => {
    ...
    it('should handle initialization lifecycle', async () => {
      ...
      try {
        ...
        // Expected in test environment - ignore lifecycle errors
