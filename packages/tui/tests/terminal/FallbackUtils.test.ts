...
import { UNICODE_REPLACEMENTS } from '../../src/terminal/UnicodeReplacements';
import type { FallbackOptions } from '../../src/terminal/FallbackTypes';
...
describe('FallbackUtils', () => {
  describe('ANSI code handling', () => {
    describe('stripAnsiColors', () => {
      ...
      test('should strip ANSI color codes with multiple parameters', () => {
      ...
      test('should handle content without ANSI codes', () => {
      ...
      test('should strip multiple ANSI color sequences', () => {
      ...
      test('should preserve non-color ANSI codes', () => {
    ...
    describe('stripAllAnsiEscapes', () => {
      test('should strip all ANSI escape sequences', () => {
      ...
      test('should preserve non-ANSI content', () => {
  ...
  describe('Unicode handling', () => {
    describe('convertToAscii', () => {
      test('should replace Unicode characters with ASCII equivalents', () => {
        const content = '▲△▼▽';
      ...
      test('should replace unknown Unicode characters with default replacement', () => {
      ...
      test('should handle mixed ASCII and Unicode content', () => {
      ...
      test('should replace Unicode characters based on code ranges', () => {
    ...
    describe('replaceUnicodeCharacter', () => {
      test('should replace characters based on Unicode code ranges', () => {
    ...
    describe('getUnicodeReplacement', () => {
      test('should return appropriate replacements for Unicode ranges', () => {
  ...
  describe('dimension limiting', () => {
    describe('limitDimensions', () => {
      test('should limit content height when exceeding maxHeight', () => {
      ...
      test('should not limit height when within maxHeight', () => {
        const content = 'Line 1\nLine 2\nLine 3';
      ...
      test('should limit content width when exceeding maxWidth', () => {
      ...
      test('should not limit width when within maxWidth', () => {
      ...
      test('should handle both height and width limiting', () => {
    ...
    describe('limitHeight', () => {
      test('should truncate height when exceeding maxHeight', () => {
      ...
      test('should not truncate when within maxHeight', () => {
    ...
    describe('limitWidth', () => {
      test('should truncate lines when exceeding maxWidth', () => {
      ...
      test('should not truncate when within maxWidth', () => {
  ...
  describe('box drawing simplification', () => {
    describe('simplifyBoxDrawing', () => {
      test('should replace Unicode box drawing characters with ASCII equivalents', () => {
        const content = '┌─┐\n│█│\n└─┘';
      ...
      test('should handle double-line box characters', () => {
        const content = '╔═══╗\n║   ║\n╚═══╝';
        const result = FallbackUtils.simplifyBoxDrawing(content);
      ...
      test('should handle rounded corners', () => {
        const content = '╭───╮\n│   │\n╰───╯';
        const result = FallbackUtils.simplifyBoxDrawing(content);
      ...
      test('should handle mixed box drawing characters', () => {
        const content = '├─┬─┤\n│ │ │\n├─┼─┤\n│ │ │\n└─┴─┘';
        const result = FallbackUtils.simplifyBoxDrawing(content);
      ...
      test('should preserve non-box-drawing characters', () => {
        const content = '┌─ Text ─┐\n│  Hello  │\n└────────┘';
        const result = FallbackUtils.simplifyBoxDrawing(content);
      ...
      test('should handle content without box drawing', () => {
        const content = 'Plain text';
        const result = FallbackUtils.simplifyBoxDrawing(content);
    ...
    describe('getBoxReplacements', () => {
      test('should return complete mapping of box drawing characters', () => {
    ...
    describe('applyBoxReplacements', () => {
      test('should apply all replacements to content', () => {
      ...
      test('should handle multiple occurrences of the same character', () => {
        const method = (FallbackUtils as any).applyBoxReplacements.bind(FallbackUtils);
        const replacements = new Map([
          ['┌', '+'],
          ['─', '-'],
  ...
  describe('layout simplification', () => {
    describe('simplifyLayout', () => {
      test('should reduce excessive spacing', () => {
      ...
      test('should simplify indentation', () => {
      ...
      test('should simplify horizontal rules', () => {
      ...
      test('should remove Unicode formatting characters', () => {
      ...
      test('should handle complex content with multiple issues', () => {
  ...
  describe('capability detection', () => {
    describe('isMinimalTerminal', () => {
      test('should return true for null capabilities', () => {
        const result = FallbackUtils.isMinimalTerminal(null);
        expect(result).toBe(true);
      });

      test('should return true for undefined capabilities', () => {
        const result = FallbackUtils.isMinimalTerminal(undefined);
        expect(result).toBe(true);
      });

      test('should return true for terminals with low color support', () => {
      ...
      test('should return true for minimal terminal types', () => {
      ...
      test('should return false for capable terminals', () => {
      ...
      test('should return false when colors property is missing', () => {
    ...
    describe('hasUnicodeSupport', () => {
      test('should return false for null capabilities', () => {
        const result = FallbackUtils.hasUnicodeSupport(null);
        expect(result).toBe(false);
      });

      test('should return false for undefined capabilities', () => {
        const result = FallbackUtils.hasUnicodeSupport(undefined);
        expect(result).toBe(false);
      });

      test('should return true for UTF-8 encoding', () => {
      ...
      test('should return true for UTF-8 in LANG variable', () => {
      ...
      test('should return true for case-insensitive UTF-8 variants', () => {
        const variants = [
          { encoding: 'utf-8' },
          { encoding: 'UTF8' },
          { encoding: 'utf8' },
      ...
      test('should return false for non-UTF-8 encodings', () => {
      ...
      test('should return false when encoding is missing', () => {
    ...
    describe('hasColorSupport', () => {
      ...
      test('should return true for terminals with 8 or more colors', () => {
      ...
      test('should return false for terminals with less than 8 colors', () => {
      ...
      test('should handle non-numeric colors property', () => {
  ...
  describe('performance and edge cases', () => {
    ...
    test('should handle content with many Unicode characters', () => {
    ...
    test('should handle content with many ANSI codes', () => {
    ...
    test('should handle edge case with very long lines', () => {
